...
import file1 from "../assets/file1.txt";
import file2 from "../assets/file2.txt";
import file3 from "../assets/file3.txt";

export const meets = [
  {
    id: "hertydsfrhrgtftyhu",
    title: "meeting1",
    description:
...
export const projects = [
  {
    id: "cd34sf2r32t7dw434t34t",
    title: "Project novel meta",
    description:
  ...
  {
    id: "zd34sf2r32dwjd434t34t",
    title: "ProjecProject novel meta",
    description:
      "The Project novel meta is a forward-thinking project that aims to blend modern design with sustainable practices. Our approach is to create spaces that not only inspire but also promote environmental stewardship.",
    covers: [image1, image2, image3],
    files: [file1, file2, file3],
